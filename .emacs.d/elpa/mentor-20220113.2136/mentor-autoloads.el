;;; mentor-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Full documentation is available under `mentor-mode'." t nil)

(autoload 'mentor-customize "mentor" "\
Call the customize function with mentor as argument." t nil)

(register-definition-prefixes "mentor" '("mentor-"))
...
(register-definition-prefixes "mentor-data" '("mentor-"))
...
(register-definition-prefixes "mentor-files" '("mentor-"))
...
(register-definition-prefixes "mentor-rpc" '("mentor-rpc-"))
...
(register-definition-prefixes "url-scgi" '("url-scgi-"))
