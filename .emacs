...
(custom-set-variables
 ...
 '(haskell-mode-hook (quote (turn-on-haskell-indentation RET-newline-and-indent)) t)
 '(safe-local-variable-values (quote ((encoding . utf-8) (Package ITERATE :use "COMMON-LISP" :colon-mode :external) (syntax . COMMON-LISP) (Syntax . Ansi-Common-Lisp) (Package . CL-USER) (Package . CL-FAD) (Syntax . COMMON-LISP) (Base . 10) (Syntax . ANSI-Common-Lisp))))
 '(slime-dfl-use-advanced-faces nil)
 '(term-bind-key-alist (quote (("C-c C-c" . term-interrupt-subjob) ("C-p" . previous-line) ("C-n" . next-line) ("C-m" . term-send-raw) ("C-_" . term-send-raw) ("M-f" . term-send-forward-word) ("M-<right>" . term-send-forward-word) ("C-<right>" . term-send-forward-word) ("M-r" . term-send-forward-word) ("M-b" . term-send-backward-word) ("M-<left>" . term-send-backward-word) ("C-<left>" . term-send-backward-word) ("M-g" . term-send-backward-word) ("M-o" . term-send-backspace) ("M-c" . term-send-up) ("M-t" . term-send-down) ("M-M" . term-send-forward-kill-word) ("M-d" . term-send-forward-kill-word) ("M-DEL" . term-send-forward-kill-word) ("C-DEL" . term-send-forward-kill-word) ("M-p" . term-send-forward-kill-word) ("M-." . term-send-backward-kill-word) ("M-<backspace>" . term-send-backward-kill-word) ("C-<backspace>" . term-send-backward-kill-word) ("C-r" . term-send-reverse-search-history) ("C-s" . term-send-forward-search-history) ("M-," . term-send-input) ("M-." . comint-dynamic-complete))))
 '(tool-bar-mode nil)
